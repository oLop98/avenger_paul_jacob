 ...
 */
final class Version20240228082655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE caillou CHANGE photo_url photo_url VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE caillou CHANGE photo_url photo_url VARCHAR(255) NOT NULL');
